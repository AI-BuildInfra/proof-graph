...
import { Entity, Source, Relationship } from '../types/index.js';
...
export interface WebPresenceAnalysis {
  ...
  summary: {
    ...
    footprint_diversity: number; // 0.0 - 1.0
  };
}
...
export class WebPresenceAnalyzer {
  ...
  public analyze(entityIdOrName: string, domainHint?: string): WebPresenceAnalysis {
    ...
    const breakdown: WebPresenceAnalysis['breakdown'] = {
