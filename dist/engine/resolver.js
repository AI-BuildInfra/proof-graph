...
export class EntityResolver {
    ...
    resolve(query) {
        ...
        for (const entity of allEntities) {
            ...
            // 2. Domain Signal
            let domainScore = 0;
            const entityUrl = entity.canonical_url || entity.metadata?.domain || '';
            ...
            // 3. GitHub Signal
            let githubScore = 0;
            const entityGithub = entity.metadata?.github || entity.metadata?.github_org || '';
            ...
            // 4. npm Scope Signal
            let npmScore = 0;
            const entityNpm = entity.metadata?.npm || entity.metadata?.npm_scope || '';
